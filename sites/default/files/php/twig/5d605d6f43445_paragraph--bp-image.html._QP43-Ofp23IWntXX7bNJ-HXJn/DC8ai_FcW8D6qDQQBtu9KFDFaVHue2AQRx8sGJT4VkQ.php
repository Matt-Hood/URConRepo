...
class __TwigTemplate_29ad9d7ab1d28871387139036054b2c60f14f24a83e00eaebb1d094ebe4ef559 extends Twig_Template
{
    ...
    {
        $tags = ["if" => 45, "set" => 46];
        $filters = ["render" => 45, "clean_class" => 129, "merge" => 138, "without" => 153];
        $functions = ["attach_library" => 40];

        try {
            $this->env->getExtension('Twig_Extension_Sandbox')->checkSecurity(
                ['if', 'set'],
                ['render', 'clean_class', 'merge', 'without'],
                ['attach_library']
            );
...
";
        // line 127
        $context["classes"] = [0 => "paragraph", 1 => ("paragraph--type--" . \Drupal\Component\Utility\Html::getClass($this->getAttribute(        // line 129
  ...
  <div class=\"paragraph__column\">
    ";
        ...
        if ( !twig_test_empty($this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->getAttribute(($context["content"] ?? null), "bp_link", [])))) {
            // line 151
            echo "      <a href=\"";
            echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute(($context["content"] ?? null), "bp_link", []), 0, []), "#url", [], "array"), "html", null, true));
            echo "\">
    ";
        }
        // line 153
...
", "modules/contrib/bootstrap_paragraphs/templates/paragraph--bp-image.html.twig", "/Applications/MAMP/ur-connected/modules/contrib/bootstrap_paragraphs/templates/paragraph--bp-image.html.twig");
    }
}
