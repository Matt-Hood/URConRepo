...
{{ main.content.field_location }}
    ...
    <div class = \"p-button\">{{ main.content.field_details }}</div>
  </div>
</div>
  </{{ main.wrapper }}>
</{{ wrapper }}>
", "themes/custom/ur_connected/templates/bs-1col--node-event-teaser.html.twig", "/Applications/MAMP/ur-connected/themes/custom/ur_connected/templates/bs-1col--node-event-teaser.html.twig");
    }
}
